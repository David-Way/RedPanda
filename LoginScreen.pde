class LoginScreen {
	...
	public void drawScreen() {
		...
		cp5.addTextfield("userName").setLabelVisible(true)
				...
				.setAutoClear(false).setGroup(g1).setId(1);
		...
		cp5.addTextfield("password")
				...
				.setText(loginPassword).setAutoClear(false).setGroup(g1)
				.setId(2);

		cp5.addButton("log in").setColorBackground(color(8, 187, 209))
				.setPosition(width / 2 - 110, 424).setImages(login_images)
				.updateSize().setGroup(g1).setId(3);
