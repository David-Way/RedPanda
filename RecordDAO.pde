public class RecordDAO{
    ...
    public Record getLastDoneRecord(int us_id, int ex_id){
    ...
    public Record getRecord(int us_id){
        String url = "http://davidway.me/kinect/api/record.php/record_table/"+ us_id;
                Record record = new Record();
                HttpClient client = new DefaultHttpClient();
                HttpGet request = new HttpGet(url);
